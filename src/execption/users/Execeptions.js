...
var ExceptionUser = /** @class */ (function () {
    ...
    ExceptionUser.prototype.executeLogout = function (_a) {
        var email = _a.email, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var senhas, validSenha;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!email && !password) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, bcryptjs_1.compare)(password, senhas === null || senhas === void 0 ? void 0 : senhas.password)];
                    case 2:
                        validSenha = _b.sent();
                        if (!validSenha) {
